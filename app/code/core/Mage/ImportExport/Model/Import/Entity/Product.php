...
class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Model_Import_Entity_Abstract
{
    ...
    protected $_particularAttributes = array(
        ...
        '_custom_option_is_required', '_custom_option_sku', '_custom_option_max_characters',
        '_custom_option_sort_order', '_custom_option_file_extension', '_custom_option_image_size_x',
        '_custom_option_image_size_y', '_custom_option_row_title', 
    ...
    protected function _saveCustomOptions()
    {
        ...
        $typeSpecific   = array(
            ...
            'date_time' => array('sku'),
            'time'      => array('sku'),
            'field'     => array('sku', 'max_characters'),
            'area'      => array('sku', 'max_characters'),
